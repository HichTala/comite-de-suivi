\begin{table}[]
    ...
    Les performances sont évaluées en mAP (\%) rapporté avec un seuil IoU à 0.5, en fonction de la combinaison \textit{dataset source $\to$ dataset cible}. Seulement la tête de classification et de regression est fine-tunée.}
