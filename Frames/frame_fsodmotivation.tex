\begin{subsectionframemod}{Few-Shot Object Detection}
    ...
    \begin{itemize}
        ...
        \item[-] \textbf{Efficacité économique et temporelle} : La détection d'objets few-shot réduit considérablement le \bfalert{temps} et les \bfalert{ressources} nécessaires à la création de grands ensembles de données annotées ainsi que l'entrainement des modèles sur ceux-ci.
    \end{itemize}
